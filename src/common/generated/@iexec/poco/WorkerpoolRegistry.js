...
export const abi = [
  ...
  {
    inputs: [{ internalType: 'address', name: '_previous', type: 'address' }],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_workerpoolOwner', type: 'address' },
      {
        internalType: 'string',
    ...
    outputs: [
      { internalType: 'contract Workerpool', name: '', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
