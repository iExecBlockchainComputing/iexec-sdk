...
test('iexec init', () => expect(execAsync('iexec init')).resolves.not.toBe(1), 10000);
...
test('iexec wallet show', () => expect(execAsync('iexec wallet show')).resolves.not.toBe(1));
...
test('iexec truffle version', () => expect(execAsync('iexec truffle version')).resolves.not.toBe(1));
