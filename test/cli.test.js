...
test('iexec wallet show', () => expect(execAsync('iexec wallet create')).resolves.not.toBe(1));
...
test('iexec truffle help', () => expect(execAsync('iexec truffle help')).resolves.not.toBe(1));
